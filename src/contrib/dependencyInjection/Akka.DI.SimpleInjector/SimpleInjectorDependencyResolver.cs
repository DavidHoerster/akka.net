...
namespace Akka.DI.SimpleInjector
{
    ...
    /// used to create actors using the SimpleInjector IoC container.
    /// </summary>
    public class SimpleInjectorDependencyResolver : IDependencyResolver
    {
        ...
        private ConditionalWeakTable<ActorBase, Container> references;
        ...
        public SimpleInjectorDependencyResolver(Container container, ActorSystem system)
        {
            ...
            this.references = new ConditionalWeakTable<ActorBase, Container>();
        }
        ...
        public Func<ActorBase> CreateActorFactory(Type actorType)
        {
            ...
            {
                var block = container;
                var actor = (ActorBase)block.GetInstance(actorType);
